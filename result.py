def get_result(test_path='data/wordsim353_agreed.txt', svd_path='data/svd_result.txt', sgns_path='data/sgns_result.txt', result_path='data/total_result.txt'):
    """
